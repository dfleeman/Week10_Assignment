...
public class MemberDao {
	...
	private final String DELETE_MEMEBERS_BY_TEAM_ID_QUERY = "DELETE FROM members WHERE team_id = ?";
	...
	public void createNewMembers(String firstName, String lastName, int teamId) throws SQLException {
	...
	public void deleteMembersByTeamId(int teamId) throws SQLException {
		PreparedStatement ps = connection.prepareStatement(DELETE_MEMEBERS_BY_TEAM_ID_QUERY);
		ps.setInt(1, teamId);
		ps.executeUpdate();
	}
